...
function removeArtist(.length, [number]) {
  artists.pop
return artists.length - [number] 
}}

console.log('Task 5:'(removeArtist[3]);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
Example: addArtist(artists) should return the artists array with the above object added to the end of the array. */
 ...
 function addArtist(artists, object) {
  ...
  "bio": "Revolutionized neo-variant art style taking elements of punk, post modern and pop art to create extremely political and explosive art. Could be placed higher on this List by the end of his career."
]  

  } return artists[20];
 }
 
 console.log('Task 6:', addArtist(object));
}
